  ...
  */
  ...
  var getCombineImpact = (function (_ref) {
    ...
    var combineWith = find(withoutDragging, function (child) {
      ...
      var childSize = destination.isCombineOnly ? childRect[axis.size] * 0.2 : childRect[axis.size];
  ...
  var getDroppableDimension = (function (_ref) {
    var descriptor = _ref.descriptor,
        ...
        isCombineOnly = _ref.isCombineOnly,
  ...
  var shared$1 = [function required(_ref) {
    ...
    !isBoolean(props.isCombineOnly) ?  invariant(false, 'isCombineOnly must be a boolean')  : void 0;
  ...
  function useValidation$1(props, contextId, getRef) {
    useDevSetupWarning(function () {
      ...
      !isInteger$1(props.index) ? "development" !== "production" ? invariant(false, prefix(id) + " requires an integer index prop") : invariant(false) : void 0;
  ...
  var makeMapStateToProps$1 = function makeMapStateToProps() {
    ...
    var getMapProps = memoizeOne(function (id, isEnabled, isDraggingOverForConsumer, isDraggingOverForImpact, dragging, isCombineOnly, renderClone) {
    ...
    var selector = function selector(state, ownProps) {
      ...
      var isCombineOnly = ownProps.isCombineOnly;
      ...
      if (state.isDragging) {
        ...
        return getMapProps(id, isEnabled, isDraggingOver, isDraggingOver, dragging, isCombineOnly, renderClone);
      }
      ...
      if (state.phase === 'DROP_ANIMATING') {
        ...
        return getMapProps(id, isEnabled, whatIsDraggedOverFromResult(completed.result) === id, whatIsDraggedOver(completed.impact) === id, _dragging, isCombineOnly, renderClone);
      }
